...
func ErrBadHeaderLength(codespace string, label string, digest btcspv.RawHeader, length int) *sdkerrors.Error {
...
func ErrBadHeight(codespace string, label string, digest btcspv.Hash256Digest) *sdkerrors.Error {
	return sdkerrors.Register(codespace, BadHeight, fmt.Sprintf(BadHeightMessage, label, digest))
}

// ErrHeightMismatch throws an error
func ErrHeightMismatch(codespace string, prevDigest, digest btcspv.Hash256Digest) *sdkerrors.Error {
...
func ErrUnknownBlock(codespace string, label string, digest btcspv.Hash256Digest) *sdkerrors.Error {
...
func ErrUnexpectedRetarget(codespace string, rawHeader btcspv.RawHeader) *sdkerrors.Error {
...
func ErrNotBestKnown(codespace string, invalidBest, expectedBest btcspv.Hash256Digest) *sdkerrors.Error {
...
func ErrNotHeaviestAncestor(codespace string, ancestor btcspv.Hash256Digest) *sdkerrors.Error {
...
func ErrNotHeavier(codespace string, newBest, prevBest btcspv.Hash256Digest) *sdkerrors.Error {
...
func ErrBadOffset(codespace string, digest btcspv.Hash256Digest) *sdkerrors.Error {
...
func ErrNotAncestor(codespace string, lca btcspv.Hash256Digest) *sdkerrors.Error {
